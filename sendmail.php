...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'noreply@vpb-hotrotieudung.online'; // Email Hostinger
        $mail->Password = 'Manhthu02@98';
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;

        // Gửi & nhận
        $mail->setFrom('noreply@vpb-hotrotieudung.online', $name);
        $mail->addAddress('nguyenloi20221@gmail.com');
        $mail->addAddress('nhatvu2309@gmail.com');
        $mail->addAddress('Buitrungduc1102@gmail.com');
        ...
        $mail->Body = "
            ...
            <strong>Gói vay:</strong> $nghe_nghiep<br>
            <strong>Số tiền muốn vay:</strong> $amount<br>
            <strong>SĐT:</strong> $phone<br>
            From website vpb-hotrotieudung.online
        ";
